...
```shell
    kafka_producer {
        enabled = true
        // one_line consolidates consumer and producer enqueue success under logger=kafka;
        // two_line also emits the consumer processing success record and uses
        // logger=kafkaproducer for producer records.
